...
if [ ! -f $srcdir/cleaned.gz -o ! -f /home/zoughi/kaldi/egs/timit/s5/backup_folder/dict/lexicon.txt ]; then
...
cat /home/zoughi/kaldi/egs/timit/s5/backup_folder/dict/lexicon.txt | awk '{print $1}' | grep -v -w '!SIL' > $dir/wordlist.all
